...
data class CustomerDto(val id: Int, val firstName: String, val lastName: String, val age: Int?, val email: String?, val address: String?)
 ...
 */
data class UpdateUserDTO(val id: Int,
